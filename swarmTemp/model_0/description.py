...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'timestamp_timeOfDay': None, u'timestamp_dayOfWeek': None, u'traffic': {'maxval': 1000.0, 'name': 'traffic', 'clipInput': True, 'minval': 0.0, 'n': 272, 'fieldname': 'traffic', 'w': 21, 'type': 'ScalarEncoder'}, u'timestamp_weekend': None}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'clParams': {'alpha': 0.050050000000000004}},
