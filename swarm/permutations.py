...
'/usr/lib64/python2.7/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  u'traffic': PermuteEncoder(maxval=1000.0, fieldName='traffic', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=1000.0, classifierOnly=True, clipInput=True, minval=0.0, n=PermuteInt(28, 521), fieldname='traffic', w=21, type='ScalarEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=traffic")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=traffic"
